...
<div class="maindivposao">

<div class="spliter"><p class="splitertext">Trenutni poslovi</p></div>
<div class="domdiv">
    ...
    while($row = mysqli_fetch_array($result,MYSQLI_BOTH)) {
        ?>
    <div class="clanakdivdom">
    <?php
        echo 'Posao: '.$row['tip_posla'].'<br>';
        echo 'Ukratko o poslu: '.$row['kratko'].'<br>';
        echo 'Opis posla: '.$row['opis_posla'].'<br>';
        echo 'Link: '.$row['link'].'<br><br>';
        ?>
    </div>
<?php
    }
