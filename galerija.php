...
<div class="maindiv" id="opop">
    <div class="naslovnidiv">
        <a href="index.html"> <img src="logo.png" class="naslov"/> </a>
        <div class="lists">
        <ul>
        <li> <?php
    ...
    <div class="spliter"><p class="splitertext">Galerije</p></div>

    <div class="galerijamain">
       <a href="prikazGalerije.php?id=<?php echo $gal_id[0]; ?>"> <div class="galerijadiv"><img  src="<?php echo $putanjaprve[0]; ?>" width=100% height=100% /><p><?php echo $title[0];?></p></div></a>
       <a href="prikazGalerije.php?id=<?php echo $gal_id[1]; ?>"> <div class="galerijadiv"><img  src="<?php echo $putanjaprve[1]; ?>" width=100% height=100% /><p><?php echo $title[1];?></p></div></a>
       <a href="prikazGalerije.php?id=<?php echo $gal_id[2]; ?>"> <div class="galerijadiv"><img  src="<?php echo $putanjaprve[2]; ?>" width=100% height=100% /><p><?php echo $title[2];?></p></div></a>
       <a href="prikazGalerije.php?id=<?php echo $gal_id[3]; ?>"> <div class="galerijadiv"><img  src="<?php echo $putanjaprve[3]; ?>" width=100% height=100% /><p><?php echo $title[3];?></p></div></a>
       <a href="prikazGalerije.php?id=<?php echo $gal_id[4]; ?>"> <div class="galerijadiv"><img  src="<?php echo $putanjaprve[4]; ?>" width=100% height=100% /><p><?php echo $title[4];?></p></div></a>
       <a href="prikazGalerije.php?id=<?php echo $gal_id[5]; ?>"> <div class="galerijadiv"><img  src="<?php echo $putanjaprve[5]; ?>" width=100% height=100% /><p><?php echo $title[5];?></p></div></a>
