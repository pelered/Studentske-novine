...
<body style="background-color: rgba(214,222,229,0.38)">
...
<div class="maindiv">
    ...
    <form action = "" method ="post">
            <div class="register"> 
            <div class="div1"><p class="div1text">Registrirajte se za pristup dodatnom sadržaju!</p></div>
            <div><input class="name" type="text" name="usrname" placeholder="Username..."/> 
                <input class="name" type="email" name="email" placeholder="E-mail..."/></div>
            <div><input class="name" type="password" name="pass" placeholder="Password..."/>
            <input class="name" type="password" name="repeatpass" placeholder="Repeat password"/></div>
            <div > <input class="regbutton" type="submit" name="regbutton" value ="Register"/> </div>
            <p class="urederror"><?php echo $error; // ispisuje error korisniku ?></p>
            </div>
        </form>
