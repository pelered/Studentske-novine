...
<h1>Resend verifikcation link?</h1>
	...
	<div class="field-group">
		<div><input type="submit" name="forgotpassword" id="forgot-password" value="Resend" class="form-submit-button"></div>
    </div>
